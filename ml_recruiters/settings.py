"""
Django base settings for ml_recruiters project.
"""
...
ROOT_URLCONF = "ml_recruiters.urls"

# https://docs.djangoproject.com/en/dev/ref/settings/#wsgi-application
WSGI_APPLICATION = "ml_recruiters.wsgi.application"
...
ADMINS = [
    ...
    ("Mohamed Nesredin", "m.n.kaizen@gmail.com"),
]
...
# django-axes
# ------------------------------------------------------------------------------
AXES_COOLOFF_TIME = timedelta(minutes=60) if DEBUG else timedelta(minutes=5)
